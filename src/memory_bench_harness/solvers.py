            ...
            "messages": [
                {
                    ...
                    "content": (
                        ...
                        "When turn metadata contains non-answer context such as "
                        "`topic`, `question_type`, or `retrieval_query`, use it to "
                        "focus retrieval interpretation and option selection, but do "
                        "not treat metadata as hidden ground truth. "
